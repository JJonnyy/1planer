...
export class PomodoroService {
	...
	async create(userId: string) {
		...
		// Нарушаем правиля для скорости , лучше вынести в отдельный метод для user, и не обращаться напрямую к prisma
		...
		const intervalsCount = user.intervalsCount ?? 7 // Используем значение по умолчанию 7
